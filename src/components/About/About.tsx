...
const About = forwardRef<HTMLDivElement, AboutProps>(
  ({ className, ...props }, ref) => {
    return (
      <div
        className={twMerge(
          " flex-center-col z-1  mobileL:pb-auto relative max-h-max  min-h-screen bg-background-about bg-cover   bg-center   bg-no-repeat pb-40 pt-20 md:min-h-screen md:py-10 mobileL:pt-10",
          className,
        )}
        {...props}
        ref={ref}
