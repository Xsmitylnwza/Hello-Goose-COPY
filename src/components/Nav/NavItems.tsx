...
const NavItems = () => {
  ...
  return (
    <>
      ...
      {toggle && (
        <motion.div className="fixed top-0 left-0 z-50 flex flex-col items-center justify-center w-full py-10 transition-all duration-500 ease-in-out bg-white bg-opacity-50 rounded-b-xl drop-shadow-2xl filter backdrop-blur-sm lg:hidden" initial={{opacity: 0}} animate={{opacity: 1, transition:{duration: 0.4, ease:"easeInOut"}}}>
          <button
