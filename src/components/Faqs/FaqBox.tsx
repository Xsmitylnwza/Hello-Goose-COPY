...
const faqs: Data[] = [
  {
    ...
    answer:
      "โครงการ Hello World ในปีนี้ เราได้มีการจัดโครงการในรูปแบบของ Hybrid หรือก็คือเรียนได้ทั้งในรูปแบบของออนไลน์(online) และแบบออนไซต์ (on-site)โดยโครงการจะเริ่มตั้งแต่วันที่ 8 พฤศจิกายน 2566 ไปจนถึง 11 ธันวาคม 2566 เราจะมีนัดเรียนกันในทุกวันพุธ เวลา 17.30 น. - 19.30 น.และทุกวันเสาร์ เวลา 09.30 น. - 17.00 น.",
  },
  {
    id: 2,
